...
export default function CondominiosPage() {
  ...
  async function criar() {
    ...
    try {
      ...
      // tipo_pagamento
      payload.tipo_pagamento = normalizeTipoPagamento(payload.tipo_pagamento);
      ...
      // leva pro form (pra ver mensagem e continuar)
  ...
  return (
    <AppShell title="Cadastro do ponto">
          ...
          return (
            <div key={c.id} className="card">
              ...
              <div className="row" style={{ marginTop: 8, gap: 8 }}>
                ...
                {canEdit && <a className="btn" href={`/condominios/${c.id}`}>Editar</a>}
              </div>
            </div>
          );
        })}
      ...
      {/* FORM */}
      {canEdit && (
        <div ref={formRef} className="card" style={{ background: "#fbfcff", marginTop: 12 }}>
          ...
          <div className="grid2">
            <div>
              ...
              <select
                className="input"
                value={normalizeTipoPagamento(form.tipo_pagamento)}
              ...
              >
                ...
                <option value="boleto">Boleto — fecha sem comprovante</option>
              </select>
              <div className="small" style={{ opacity: 0.7, marginTop: 4 }}>
                Isso controla a exigência de comprovante no fechamento.
              </div>
            </div>
            <div />
          </div>
